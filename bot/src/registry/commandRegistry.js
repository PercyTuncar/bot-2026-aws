...
const commands = [
  ...
  { name: 'rob', aliases: ['robar'], category: 'economy', permission: 'all', cooldown: 'rob', handler: robCommand },
  { name: 'crime', aliases: ['crimen'], category: 'economy', permission: 'all', cooldown: 'crime', handler: crimeCommand },
